...
Foram importados os ficheiros .php (contendo o UnityWebGL para vizualização do jogo) e a base de dados via FTP (FileZilla). Desta forma, qualquer utilizador pode testar 
...
(certificado SSL automático exige domínio privado -> pago)
